...
const LEARN_CATION_CARDS = [
  {
    ...
    description:
      '학습(Learn)과 휴가(Vacation)<br/>집이 아닌 새로운 공간에서 학습과 휴가를 동시에 경험하세요.',
    caption: '* 우수 훈련생 조건 - 직전 3개월 평균 출석율 97%',
    image:
      'https://statics.goorm.io/ktcloud-techup/landing/assets/learncation/techup_learncation_01.png',
    alt: '제주에서의 특별한 경험',
  },
  {
    id: 1,
    title: '휴가와 학습을 동시에',
    description:
      '제주도에서 온/오프라인으로 프로젝트를 수행하며<br/>챌린저들과 추억을 만들어보세요.',
    caption: '',
    image:
      'https://statics.goorm.io/ktcloud-techup/landing/assets/learncation/techup_learncation_02.png',
    alt: '휴가와 학습을 동시에',
  },
  {
    id: 2,
    ...
    caption: '',
    image:
      'https://statics.goorm.io/ktcloud-techup/landing/assets/learncation/techup_learncation_03.png',
    alt: '함께하는 성장과 네트워킹',
  },
];
          ...
          {LEARN_CATION_CARDS.map((card, index) => (
            ...
            >
              <div className="image-container">
                ...
                <img src={card.image} alt={card.alt} className="main-image" />
              </div>
                ...
                <div className="card-content">
                  <div className="card-text">
                    ...
                    <Text
                      typography="body1"
                      foreground="accent"
                      className="learn-cation-description"
                    >
