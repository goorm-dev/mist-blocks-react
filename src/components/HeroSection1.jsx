          ...
          <div className="hero-top-row">
            <div className="hero-left-container">
              ...
              <div className="hero-title">
                <Text typography="display4" foreground="normal">
            ...
            <div className="hero-right-container">
              ...
              <picture id="hero-main-picture">
                ...
                <img src="/landing_skeleton/source/img-default-hero-right.png" alt="main-image" className="hero-right-image" />
              </picture>
            </div>
          </div>
            ...
            {[
              {
                ...
                imageSrc: "/landing_skeleton/source/img-default.png"
              },
              {
                label: "라벨 2", 
                title: "서브 타이틀 2",
