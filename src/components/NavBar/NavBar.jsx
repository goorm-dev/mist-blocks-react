      ...
      <nav aria-label="Global" className="container flex items-center justify-between p-6 lg:px-8">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <img
              alt=""
              src="https://oopy.lazyrockets.com/api/rest/cdn/image/01976835-e46a-70be-a5bc-0e8bdfa7610c.png"
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <Popover className="relative">
            ...
            <PopoverPanel
              transition
              className="absolute left-1/2 z-10 mt-3 w-screen max-w-4xl -translate-x-1/2 overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5 transition data-closed:translate-y-1 data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in"
            >
