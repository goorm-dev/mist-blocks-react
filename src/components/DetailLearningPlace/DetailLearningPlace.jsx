        ...
        <div className="learning-place-slider-container">
          ...
          <div className="learning-place-slider original">
            {images.map((image, index) => (
              <div key={`original-${index}`} className="learning-place-slide">
          ...
          <div className="learning-place-slider clone">
            {images.map((image, index) => (
              <div key={`clone-${index}`} className="learning-place-slide">
                <img src={image} alt={`학습 공간 ${index + 1}`} className="learning-place-image" />
              </div>
            ))}
          </div>
        ...
        <div className="learning-places-container">
          ...
          <div className="learning-place-card">
            <div className="learning-place-card-header">
              <Text typography="heading4" foreground="normal" className="learning-place-card-title">
                구름스퀘어 강남
              </Text>
              <a
                target="_blank"
                href="https://map.naver.com/p/entry/place/1318967756?placePath=%2Fhome"
              >
                <Text as="span" typography="heading6" className="learning-place-card-link">
                  위치 확인
                </Text>
              </a>
            </div>
            <div className="learning-place-card-content">
              <Text typography="body1" foreground="normal-lighter">
                구름스퀘어 강남의 쾌적한 공간에서 팀원들과 직접 협업하며 실무와 같은 프로젝트 경험을
                쌓을 수 있습니다. 대면 소통을 통해 커뮤니케이션과 팀워크 역량을 자연스럽게 키울 수
                있습니다.
              </Text>
            </div>
          </div>
          ...
          <div className="learning-place-card">
            ...
            <div className="learning-place-card-content">
              <Text typography="body1" foreground="normal-lighter">
                대회 가상현실 기반의 메타버스 환경에서 시간과 장소 제약 없이 몰입감 있는 학습과
                협업을 경험할 수 있습니다. 실제와 유사한 협업 과정을 온라인에서도 생생하게 체험할 수
                있습니다.
              </Text>
            </div>
          </div>
