...
const DUMMY_COMMENTS = [
  {
    ...
    title: '실무에 도움되는 강의',
    description:
      '실무에 바로 적용할 수 있는 내용이 많아서 정말 도움이 되었습니다. 특히 실제 프로젝트 사례를 바탕으로 한 예제가 이해하기 쉬웠습니다.',
  ...
  },
  {
    ...
    title: '체계적인 커리큘럼',
    description:
      '기초부터 고급 내용까지 체계적으로 구성되어 있어서 학습 흐름이 끊기지 않고 잘 따라갈 수 있었습니다.',
  ...
  },
  {
    ...
    title: '멘토의 실시간 피드백',
    description:
      '과제에 대한 멘토의 상세한 피드백이 많은 도움이 되었습니다. 특히 코드 리뷰를 통해 더 나은 방향으로 개선할 수 있었습니다.',
  ...
  },
  {
    ...
    title: '유익한 네트워킹',
    description:
      '같은 분야를 공부하는 다른 수강생들과의 교류가 큰 자산이 되었습니다. 서로 의견을 나누며 더 넓은 시야를 가질 수 있었습니다.',
