...
const RecommendCommentCard = ({
  ...
  return (
    <div
      ref={wrapRef}
      className={`rc-card-wrapper ${isSmallScreen ? 'small-screen-static' : ''} ${className}`.trim()}
      style={cardStyle}
    >
      <section 
        ref={cardRef} 
            ...
            <div className="rc-user-info">
              <div className="rc-user-text">
                <div className="rc-title">
                  <Text typography="subtitle1" className="profile-content-title" foreground="normal">{title}</Text>
                </div>
                <div className="rc-description">
                  <Text typography="body2" foreground="normal">{description}</Text>
                </div>
              </div>
            </div>
          </div>
