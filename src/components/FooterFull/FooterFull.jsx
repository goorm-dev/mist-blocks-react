  ...
  return (
    <li key={course}>
      <Link href={hrefLink} className="footer-link">
        <Text as="span" typography="heading6" foreground="inherit">
          {COURSE_INFORMATION[course].title}
        </Text>
      </Link>
    </li>
  );
...
const FooterCourseList = ({ area }) => {
  ...
  return (
    <div className="footer-links-block footer-section-vertical">
      <Text typography="subtitle1" className="footer-title" foreground="hint">
        {title}
      </Text>
  ...
  useEffect(() => {
    ...
    const detectThemeOriginal = () => {
      ...
      const isDark =
        ...
        backgroundColor.trim() !== '#FFFFFF' &&
        backgroundColor.trim() !== '#fff' &&
        backgroundColor.trim() !== '#FFF';

      console.log(backgroundColor, isDark);
        ...
        <div className="footer-content">
          <div className="footer-info-column">
            ...
            <div className="footer-section footer-section-vertical">
              <div className="footer-logo">
                ...
                >
                  <img
                    src={
                      isDarkTheme
                        ? 'https://statics.goorm.io/ktcloud-techup/logo/techup_dark.svg'
                        : 'https://statics.goorm.io/ktcloud-techup/logo/techup_light.svg'
                    }
              ...
              <div className="social-icons">
                <a
                  href="https://www.youtube.com/@ktcloud"
                  target="_blank"
          ...
          <div className="footer-links-column">
            <div className="footer-links-wrapper">
              {COURSE_AREA_LIST.map(area => (
                <FooterCourseList key={area} area={area} />
              ))}
            </div>
          </div>
        ...
        <div className="footer-bottom-content">
          <div className="footer-info-text">
            <div className="footer-info-group">
              <Link
                href={
                  'https://vivid-thyme-ac6.notion.site/kt-cloud-TECH-UP-2479e3e335cc80dbb7fae14d3c6040d4'
                }
                className="footer-link"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Text as="span" typography="subtitle1" foreground="secondary">
                  {'개인정보처리방침'}
                </Text>
              </Link>
              <Text as="p" typography="subtitle1" foreground="secondary">
                {'고객센터 ㅣ 평일 10:30 - 17:00 (휴게 시간 12:00 - 13:30, 주말 및 공휴일 휴무)'}
              </Text>
            </div>
            <div className="footer-info-text-copyright">
              <Text as="p" typography="body2" foreground="hint">
          ...
          <div className="footer-ktcloud-logo">
            <a
              href="https://www.ktcloud.com"
              target="_blank"
              className="footer-ktcloud-logo-link"
              aria-label="kt cloud 홈페이지 이동"
            >
              <img
                src={
                  isDarkTheme
                    ? 'https://statics.goorm.io/ktcloud-techup/logo/ktcloud_dark.svg'
                    : 'https://statics.goorm.io/ktcloud-techup/logo/ktcloud_light.svg'
                }
                alt="kt cloud"
