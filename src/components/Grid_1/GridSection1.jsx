              ...
              <div className="card-info">
                <div className="card-info-text">
                  <div className="card-subheading-container">
                    <Text typography="heading6" className="card-subheading">
                      {card.subheading}
                    </Text>
                    {/* 뱃지 UI 적용 */}
                  ...
                  <Text typography="heading2" className="card-heading">
                    {card.heading}
                  </Text>
                  <Text typography="body1" className="card-description paragraph-lg">
                    {card.description}
                  </Text>
                </div>
              </div>
